...
router.post("/confirm-payment", async (req, res) => {
  const { paymentIntentId,name, surname, address, codePostal,country,city, productIds, email, total, currentTotal, products, orderId, date, delivery, service_point_id } = req.body;
  ...
  try {
    ...
    if (paymentIntent.status === "succeeded") {
        ...
        return (
          ...
          <tr>
            <td class="outer-td" style="padding: 0 40px; border-bottom: 1px solid #F2EFEB;">
              ...
              font-size:13px; font-weight:500; color:#1A1A1A;">${(item.price/100).toFixed(2)} €</p>
      ...
      // 3. Contenu du mail
      const mailOptions = {
        from: `"Nahilys" <${process.env.EMAIL_USER}>`,
        to: email,
              ...
              <table cellpadding="0" cellspacing="0" border="0" align="center" style="margin-bottom:18px;">
                <tr>
                  <td width="44" height="44" align="center" valign="middle" style="border: 1px solid #C9A96E; border-radius: 50%;">
                    <img src="https://www.nahilys.com/assets/icons/check.png" width="18" height="18" alt="✓" style="display:block;" onerror="this.style.display='none'; this.parentNode.innerHTML='&#10003;';" />
                  </td>
                </tr>
              </table>
          ...
          <tr>
            ...
            font-weight:300; color:#777; padding-bottom:8px;">${(delivery/100).toFixed(2)} €</td>
                ...
                <tr>
                  ...
                  font-size:22px; font-weight:600; color:#1A1A1A;">${(total/100).toFixed(2)} €</td>
                      </tr>
                    </table>
                  </td>
                </tr>
    ...
    <tr>
      <td align="center" style="padding: 32px 16px;">
        ...
        text-transform:uppercase; color:#C9A96E;">
              ...
              <p class="hero-title" style="margin:0 0 12px 0; font-family:'Playfair Display',Georgia,serif;
        font-size:26px; font-weight:400; color:#1A1A1A; line-height:1.35;">
                Commande a préparer pour <em style="font-style:italic; color:#C9A96E;">${surname} ${name}</em>
              </p>
          ...
          <!-- ========== INFO CLIENT ========== -->
          <tr>
            <td style="padding: 40px 40px 32px; border-bottom: 1px solid #EBEBEB;">

              <p style="margin:0; font-family:'Inter',Arial,sans-serif;
        font-size:13px; font-weight:400; color:#1A1A1A; line-height:1.7;">
                Information sur le client :
              </p>

              <p style="margin:0; font-family:'Inter',Arial,sans-serif;
        font-size:13px; font-weight:300; color:#888888; line-height:1.7;"><span style="color:#1A1A1A">Nom :</span> ${surname} ${name}</p>
              <p style="margin:0; font-family:'Inter',Arial,sans-serif;
        font-size:13px; font-weight:300; color:#888888; line-height:1.7;"><span style="color:#1A1A1A">Email :</span> : ${email}</p>
              <p style="margin:0; font-family:'Inter',Arial,sans-serif;
        font-size:13px; font-weight:300; color:#888888; line-height:1.7;"><span style="color:#1A1A1A">Addresse :</span> ${address} ${codePostal} ${city}, ${country}</p>
              <p style="margin:0; font-family:'Inter',Arial,sans-serif;
        font-size:13px; font-weight:300; color:#888888; line-height:1.7;"><span style="color:#1A1A1A">Point Relais ID :</span> ${service_point_id} </p>
            </td>
          </tr>
        ...
        font-size:8px; font-weight:500; letter-spacing:3.5px;
        text-transform:uppercase; color:#AAAAAA;">
                Sélection du client ${surname} ${name}
              </p>
            </td>
          </tr>
